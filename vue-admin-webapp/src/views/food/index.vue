<template>
  <div>
    <div class="item">
      <input type="text" v-model="name" placeholder="吃前查一查更健康" v-on:input="changetext"/>
    ...
    <el-table :data="tableData">
      ...
      <el-table-column prop="sugar" label="糖分">
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods:{
    ...
    queryadd (item) {
        this.url = "/api/food_heat/food/details?foodId=" + item.foodId + "&page=1&app_id=kjngvptstfopqhpk&app_secret=TnZTSkVuOUpsOERFMndoMnNvQ3pNUT09"
    ...
    clickTest() {
      this.url = "/api/food_heat/food/search?keyword=" + this.name + "&page=1&app_id=kjngvptstfopqhpk&app_secret=TnZTSkVuOUpsOERFMndoMnNvQ3pNUT09"
      console.log(this.url)
      axios
        .get(this.url)
        .then(response=> {
